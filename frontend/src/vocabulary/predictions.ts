import {
    ...
    GET_FEED_SEGMENT,
    GET_FEED_TITLE,
    GET_MARKET_DEMAND_DATA, GET_MARKET_DEMAND_FORECAST_DATA,
...
export const VocabularyPredictions: VocabularyObject = {
    MarketDemand: {
        request: GET_MARKET_DEMAND_FORECAST_DATA,
        responseKey: 'getMarketDemandsForecast',
...
export const VocabularyPredictionsDomains = Object.keys(VocabularyPredictions);
